    ...
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="templatemo_main_nav">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="products.jsp">Services</a>
                </li>
                <li class="nav-item">
                    ...
                    <div class="col-lg-6 mb-0 d-flex align-items-center">
                        <div class="text-align-left align-self-center">
                            ...
                            <p class="text-dark fs-10">
                                High-quality printing services for Business Cards, Stickers,
                                Banners, and Corporate Apparel.
...
<section class="container py-5">
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-4 p-5 mt-3 text-center">
            <a href="products.jsp?id=1">
                <img src="assets/img/Tshirt.jpg" class="rounded-circle img-fluid">
            </a>
            <h5 class="mt-3 mb-3">T-shirt Printing</h5>
            <p>
                <a href="products.jsp?id=1" class="btn btn-success">View Details</a>
            </p>
        </div>

        <div class="col-12 col-md-4 p-5 mt-3 text-center">
            <a href="products.jsp?id=2">
                <img src="assets/img/apron.jpg" class="rounded-circle img-fluid">
            </a>
            <h2 class="h5 mt-3 mb-3">Apron Printing</h2>
            <p>
                <a href="products.jsp?id=2" class="btn btn-success">View Details</a>
            </p>
        </div>

        <div class="col-12 col-md-4 p-5 mt-3 text-center">
            <a href="products.jsp?id=3">
                <img src="assets/img/flyers.jpg" class="rounded-circle img-fluid">
            </a>
            <h2 class="h5 mt-3 mb-3">Flyers</h2>
            <p>
                <a href="products.jsp?id=3" class="btn btn-success">View Details</a>
            </p>
        </div>
...
<footer class="bg-dark pt-5" id="tempaltemo_footer">
    <div class="container text-light text-center pb-4">
        <h2 class="h2 border-bottom pb-3 border-light logo"
            style="color: var(--mongoose) !important;">
            Rheaka Design
        </h2>
